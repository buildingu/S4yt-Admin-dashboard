...
const SidebarRail = React.forwardRef(({ className, ...props }, ref) => {
  ...
  return (
    (<button
      ...
      className={cn(
        "bg-[#242424]",
        "absolute inset-y-0 z-[-999] hidden w-4 -translate-x-1/2 transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] hover:after:bg-sidebar-border group-data-[side=left]:-right-4 group-data-[side=right]:left-0 sm:flex",
...
const SidebarMenuItem = React.forwardRef(({ className, ...props }, ref) => (
  <li
    ...
    className={cn("group/menu-item relative bg-[#242424]", className)}
    {...props} />
))
